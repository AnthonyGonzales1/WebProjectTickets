<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebConsultTipoTicket.aspx.cs" Inherits="WebProjectTickets.Consultas.WebConsultTipoTicket" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="text-center">
            <div class="col-md-12">
                <h1 class="page-header">Consulta Tipo Tickets</h1>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6 col-xs-8">
            <asp:DropDownList type="button" class="btn btn-dark dropdown-toggle" ID="FiltroDropDownList" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" runat="server">
                ...
                <asp:ListItem>TipoTicketId</asp:ListItem>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4">
            <asp:Label ID="Label5" runat="server" Text="Hasta">Hasta:</asp:Label>
    ...
    <div class="form-group">
        <div class="table table-responsive col-md-12">
            <asp:GridView ID="TipoTicketGridView" class="table table-bordered table-hover table-striped table-responsive" AutoGenerateColumns="False" runat="server" Height="67px">
                <Columns>
        ...
        <div class="modal-dialog modal-sm" style="max-width: 600px!important; min-width: 300px!important">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <rsweb:ReportViewer ID="TipoTicketReportViewer" runat="server" ProcessingMode="Remote" Height="400px" Width="500px">
