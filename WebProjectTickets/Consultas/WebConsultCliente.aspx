        ...
        <div class="justify-content-start">
            <div class="col-md-6 col-xs-8">
                <div class="form-group" style="display: inline-block">
                    <asp:LinkButton ID="ImprimirLinkButton"data-toggle="modal" data-target=".bd-example-modal-lg" runat="server">Imrpimir</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm" style="max-width: 600px!important; min-width: 300px!important">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <rsweb:ReportViewer ID="ClienteReportViewer" runat="server" ProcessingMode="Remote" Height="400px" Width="500px">
