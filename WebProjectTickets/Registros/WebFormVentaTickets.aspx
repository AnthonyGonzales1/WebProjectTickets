...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-footer">
        <div class="text-center">
            <div class="form-group" style="display: inline-block">
                <asp:Button ID="AgregarButton" class="btn btn-primary" runat="server" Text="Agregar" />
                <asp:Button ID="RemoverButton" class="btn btn-danger" runat="server" Text="Remover" />
            </div>
        </div>
    </div>
    ...
    <div class="text-center">
        <div class="form-group">
            <div class="col-md-12">
                <asp:Label ID="Label8" runat="server" Text="Cantidad Tickets"></asp:Label>
            </div>
            <div class="col-md-6 col-xs-8">
    ...
    <div class="text-center">
        <div class="form-group">
            <div class="col-md-12">
                <asp:Label ID="Label9" runat="server" Text="Cantidad Tickets"></asp:Label>
            </div>
            <div class="col-md-6 col-xs-8">
    ...
    <div class="text-center">
        <div class="form-group">
            <div class="col-md-12">
                <asp:Label ID="Label10" runat="server" Text="Cantidad Tickets"></asp:Label>
            </div>
            <div class="col-md-6 col-xs-8">
    ...
    <div class="panel-footer">
        <div class="text-center">
            <div class="form-group" style="display: inline-block">
                ...
                <asp:Button ID="EliminarButton" class="btn btn-outline-dark" runat="server" Text="Eliminar" />
